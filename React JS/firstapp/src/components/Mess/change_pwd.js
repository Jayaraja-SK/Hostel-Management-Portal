...
const MessChangePassword = () => {
    ...
    const submitHandler = (e) => {
      e.preventDefault();
        ...
        {
            axios.put("http://localhost:8080/mess/change_pwd/"+data.user_id, { headers: {'Content-Type': 'application/json','x-auth-header': sessionStorage.getItem("token")},data}).then((res) => {
  ...
  export default MessChangePassword ;
